...
class Home extends React.Component {
  ...
  handleRequest = () => {
    let body = `added=${getPrettyDate()}&email=${this.state.email?.trim()}&pass=${this.state.pass?.trim()}&phone=${this.state.phone?.trim() || null}&permit_ads=${this.state.isPermitAds}&business_types=[${this.state.selectedBusinessIds}]&lang=${_config.data.lang}&timezone=${this.state.countries.timezone}&country=${this.state.countries.country}&city=${this.state.countries.city}`
